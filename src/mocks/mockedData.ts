...
export const mockedActor: IMovieActor = {
  adult: false,
  gender: 2,
  id: 976,
...
export const mockedDetailMovie = {
  adult: false,
  backdrop_path: '/5i6SjyDbDWqyun8klUuCxrlFbyw.jpg',
  belongs_to_collection: {
    id: 553717,
    name: 'Creed Collection',
    poster_path: '/c5iwhO9Oqx5zusx0VeaoyxP50Wr.jpg',
    backdrop_path: '/qIRBVovMpYsEi5LUXN4WULYXLpC.jpg',
  },
  budget: 75000000,
  genres: [
    {
  ...
  production_companies: [
    ...
    {
      id: 102334,
      logo_path: '/baWl2NMe4hiIsoJ94tv32uhYQ7z.png',
